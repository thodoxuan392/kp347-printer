...
void printer_init(); // Stream *s = &Serial, uint8_t dtr = 255);
size_t
/*!
...
printer_begin(),
     ...
     */
    printer_printBarcode(const char *text, uint8_t type),
    /*!
     ...
     * @param fromProgMem
     */
    printer_printBitmap(int w, int h, const uint8_t *bitmap, bool fromProgMem),
    /*!
     * @brief Prints a bitmap
     * @param w Width of the image in pixels
     * @param h Height of the image in pixels
     ...
     */
    printer_setSize(char value),
    /*!
     * @brief Sets print and feed speed
     * @param p print speed
     * @param f feed speed
     */
    printer_setTimes(unsigned long, unsigned long),
    /*!
    ...
    printer_setHeatConfig(uint8_t dots, uint8_t time, uint8_t interval),
    /*!
     ...
     */
    printer_sleepAfter(uint16_t seconds),
    /*!
     ...
     */
    printer_tab(), // Only works w/recent firmware
    /*!
     ...
     */
    printer_timeoutSet(unsigned long),
    /*!
     ...
     */
    printer_upsideDownOff(),
    /*!
     * @brief Enables upside-down text mode
     */
    printer_upsideDownOn(),
    /*!
...
void printer_writeBytes(uint8_t a), //, writeBytes(uint8_t a, uint8_t b),
                                    // writeBytes(uint8_t a, uint8_t b, uint8_t c),
                                    // writeBytes(uint8_t a, uint8_t b, uint8_t c, uint8_t d),
    printer_setPrintMode(uint8_t mask), printer_unsetPrintMode(uint8_t mask),
    printer_writePrintMode(), printer_adjustCharValues(uint8_t printMode);
// };
